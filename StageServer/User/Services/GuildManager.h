		...
		namespace StageServer {
			...
			*/
			...
			public: // packet processors
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Create& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Invite& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::InviteReply& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Join& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Kick& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Leave& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ListMembers& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::Remove& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ValidateName& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ValidateAlias& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::AddExp& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::AddMaintenancePoint& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ReflashGuildLevel& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::GetTax& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ReflashGuildShopItem& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::MessageChange& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ChangeGrade& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ChangeGradeName& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ChangeGradeAuth& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ChangeGuildMaster& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::GetMyInfo& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::RefreshMyInfo& packet);
				void Dispatch(UserSharedPtr user, Protocol::ToServer::AllMGuild::ReflashGuildProfitDate& packet);
			public:
