    ...
    namespace XRated {
        ...
        public:
            ...
            void Connect(F f)
            {
                ...
                auto lambda = [f](TClientProxySharedPtr& client, Net::StreamReader& streamReader)
                {
                    /*
            ...
            bool /* operator() */ Invoke(TClientProxySharedPtr& client, const uint16_t& packetHeaderHash, Net::StreamReader streamReader)
            {
        ...
        private:
            ...
            std::map<uint16_t, std::function<void(TClientProxySharedPtr&, Net::StreamReader&)>> m_callbacks;
        };
    }
}
