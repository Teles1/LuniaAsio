...
namespace Lunia
{
	namespace XRated
	{
		namespace Lunia
		{
			...
			inline float StaticStatCalculator::CalculateHitIgnorHpRateSpecificWith(const uint32) const
			{
				return 0.2f;
			}

			inline float StaticStatCalculator::CalculateSkillDamageSpecificWithVitality(const uint32) const
			{
				return 0.0f;
			}

			inline float StaticStatCalculator::CalculateCoolDownSpecificWith(const uint32 dexterity) const
			{
				if (dexterity < 500)
				{
			...
			inline float StaticStatCalculator::CalculateCriticalProbabilitySpecificWith(const uint32 dexterity) const
			{
				if (dexterity < 500)
				{
			...
			inline float StaticStatCalculator::CalculateSkillDamageSpecificWithDexterity(const uint32) const
			{
				return 0.0f;
			}

			inline float StaticStatCalculator::CalculateCoolDownNormalWith(const uint32 dexterity) const
			{
				if (dexterity < 500)
				{
					return static_cast<float>(dexterity) / 3300.0f;
			...
			inline float StaticStatCalculator::CalculateCriticalProbabilityNormalWith(const uint32 dexterity) const
			{
				if (dexterity < 500)
				{
					return static_cast<float>(dexterity) * 0.0004f;
			...
			inline float StaticStatCalculator::CalculatePhysicalCriticalFactorNormalWith(const uint32 vitality) const
			{
				return static_cast<float>(vitality) * 0.00005f;
			}

			inline float StaticStatCalculator::CalculatePhysicalCriticalFactorSpecificWith(const uint32 vitality) const
			{
				if (vitality < 500)
				{
			...
			inline float StaticStatCalculator::CalculateMagicalCriticalFactorSpecificWith(const uint32 intelligence) const
			{
				if (intelligence >= 500)
				{
			...
			inline float StaticStatCalculator::CalculateMagicalCriticalFactorNormalWith(const uint32 intelligence) const
			{
				return static_cast<float>(intelligence) * 0.00005f;
			}

			inline float StaticStatCalculator::CalculateSkillDamageSpecificWithIntelligence(const uint32) const
			{
				return 0.0f;
			}
			...
			inline float StaticStatCalculator::CalculateSkillDamageFactorWithStrength(const uint32 strength, const XRated::Constants::GameTypes gameType) const
			{
			...
			inline float StaticStatCalculator::CalculateHealIncRate(const uint32 intelligence) const
			{
				if (intelligence >= 500)
				{
			...
			inline float StaticStatCalculator::CalculateMaxHp(const uint32 vitality, const XRated::Constants::GameTypes gameType) const
			{
				if (gameType & XRated::Constants::GameTypes::PvpGameTypeMask)
				{
					if (vitality >= 500)
			...
			inline float StaticStatCalculator::CalculateMaxMp(const uint32 intelligence, const XRated::Constants::GameTypes gameType) const
			{
				if (gameType & XRated::Constants::GameTypes::PvpGameTypeMask)
				{
					if (intelligence >= 500)
